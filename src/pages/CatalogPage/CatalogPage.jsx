                ...
                <div className={s.sort__category}>
                    <div className={s.category}>
                        ...
                        <div className={s.btns}>
                            ...
                            <button onClick={() => setCategory(1)}> Гардеробные</button>
                            <button onClick={() => setCategory(2)}>Диваны</button>
                            <button onClick={() => setCategory(3)}>Столы и стулья</button>
                            <button onClick={() => setCategory(4)}>Кухни</button>
                        </div>
                    </div>
...

                    {
                        sortedFilteredTovars.length ? (
                            sortedFilteredTovars.map((tovar) => {
                                return <Item id={tovar.id} img={tovar.img} name={tovar.name} desc={tovar.desc} price={tovar.price} count={tovar.count} />
